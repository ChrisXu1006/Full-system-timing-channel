...
plab4_net_srcs = \
  plab4-net-RingNetSimple.v \
  plab4-net-RouterInputCtrl.v \
  plab4-net-RouterInputTerminalCtrl.v \
  plab4-net-RouterOutputCtrl.v \
  plab4-net-RouterBase.v \
  plab4-net-RingNetBase.v \
  plab4-net-RouterAlt.v \
  plab4-net-RingNetAlt.v \
  plab4-net-RouterInputCtrl-TP.v \
  plab4-net-RouterInputTerminalCtrl-TP.v \
  plab4-net-RouterOutputCtrl-TP.v \
  plab4-net-RouterBase-TP.v \
  plab4-net-RingNetBase-TP.v \
  plab4-net-RingNetBase-NoTP.v \
...
plab4_net_test_srcs = \
  ...
  plab4-net-RouterInputCtrl-TP.t.v \
  plab4-net-RouterInputTerminalCtrl-TP.t.v \
  plab4-net-RouterOutputCtrl-TP.t.v \
  plab4-net-RouterBase-TP.t.v \
  plab4-net-RingNetBase-TP.t.v \
  plab4-net-RingNetBase-NoTP.t.v \
...
plab4_net_pyv_srcs = \
  ...
  plab4-net-input-gen-TP_urandom.py.v \
  plab4-net-input-gen-TP_tornado.py.v \
