...
include_partial_subpkgs_full_files = [
  ...
  "plab5-mcore/plab5-mcore-ProcCacheNetAlt.t.v",
  "plab5-mcore/plab5-mcore-ProcCacheNetBase.t.v",
  "plab5-mcore/plab5-mcore-sim-base.v",
  "plab5-mcore/plab5-mcore-sim-alt.v",
  "plab5-mcore/plab5-mcore-sim-harness.v",
...
include_partial_subpkgs_strip_files = [
  "plab5-mcore/plab5-mcore-ProcCacheNetBase.v",
  "plab5-mcore/plab5-mcore-ProcCacheNetAlt.v",
